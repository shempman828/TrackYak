...
# MergeDB.merge_entities must clean up the artist_images/ file for the
# merged-away entity: unlink whichever picture the merge did not keep, and
# rename a kept source picture onto the surviving entity's id.
