"""Tests for RoleAlias awareness in the file-tag import credit path
(docs/specs/split_and_merge_aliases.md). A credit whose role name is
recorded in the RoleAlias table (from a merge, or added by hand) must
resolve to that canonical Role instead of
TrackImporter._create_track_artist_relationships spawning a duplicate --
the same alias-aware path the genre import and MusicBrainz import credit
paths already use.
"""
