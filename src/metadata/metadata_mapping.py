...
ID3_TRACK_MAPPINGS = {
    ...
    "TXXX:MusicBrainz Release Track Id": {"field": "MBID", "type": str, "entity": "Track"},
}
...
ID3_ALBUM_MAPPINGS = {
    ...
    "TXXX:MusicBrainz Album Type": {"field": "release_type", "type": str, "entity": "Album"},
    "TXXX:MusicBrainz Album Status": {"field": "status", "type": str, "entity": "Album"},
}
ID3_PUBLISHER_MAPPINGS = {"TPUB": {"field": "publisher_name", "type": str, "entity": "Publisher"}}
...
VORBIS_TRACK_MAPPINGS = {
    ...
    "TITLE_TRANSLATION": {"field": "track_name_translated", "type": str, "entity": "Track"},
    ...
    "TIMESIGNATURE": {"field": "primary_time_signature", "type": str, "entity": "Track"},
    ...
    "CLASSICALPREFIX": {"field": "classical_catalog_prefix", "type": str, "entity": "Track"},
    "CLASSICALCATALOGNUMBER": {"field": "classical_catalog_number", "type": int, "entity": "Track"},
    ...
    "CHANNELCOHERENCE": {"field": "channel_coherence", "type": float, "entity": "Track"},
    "CRESTFACTOR": {"field": "crest_factor", "type": float, "entity": "Track"},
    "AUDIOPHILESCORE": {"field": "audiophile_score", "type": float, "entity": "Track"},
    "SPECTRALCENTROID": {"field": "spectral_centroid", "type": float, "entity": "Track"},
    "SPECTRALFLATNESS": {"field": "spectral_flatness", "type": float, "entity": "Track"},
...
VORBIS_ARTIST_MAPPINGS = {
    ...
    "PRODUCER": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Producer"},
    "REMIXER": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Remixer"},
    "WRITER": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Writer"},
    "VOCALS": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Vocalist"},
    "VOCALIST": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Vocalist"},
    "SPOKEN": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Narrator"},
    "NARRATOR": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Narrator"},
    "ORCHESTRA": {"field": "artist_name", "type": str, "entity": "Artist", "role": "Orchestra"},
...
WAV_ALBUM_MAPPINGS = {"IPRD": {"field": "album_name", "type": str, "entity": "Album"}}
