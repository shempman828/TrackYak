"""A two-level (decades, then years) click-to-select year timeline themed for dark_mode.qss."""
...
class TimelineWidget(QWidget):
    """A click-to-drill-down timeline: decades expand into individual years."""

    yearSelected = Signal(int)  # emits the chosen int year; API kept stable for callers
    ...
    def paintEvent(self, event):
        ...
        for i, item in enumerate(items):
            ...
            label = str(item) if in_year_view else f"{item}s"  # e.g. "1990s"
